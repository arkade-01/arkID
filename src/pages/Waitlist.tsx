    ...
    <div className="min-h-screen bg-gray-200 font-custom">
      <div className="container mx-auto px-4 py-4 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-8">
          ...
          <div className="lg:col-span-2 order-2 lg:order-1">
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-8">
              ...
              <div className="">
                ...
                <div className="space-y-4 flex flex-col items-center justify-center lg:block">
                  <div>
                    <input
                      type="text"
                      name="name"
                      ...
                      className="w-full lg:max-w-[712px] max-w-[383px] px-3 py-3 bg-transparent active:bg-bg-transparent  border-[1px] border-[#1C1C1E] focus:border-transparent text-base"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="relative">
                      <select
                        ...
                        onChange={handleInputChange}
                        className="w-full lg:max-w-[250px] max-w-[187.5px] px-3 py-3 bg-transparent active:bg-bg-transparent  border-[1px] border-[#1C1C1E]  focus:border-transparent text-base"
                      >
                    ...
                    <div>
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full lg:max-w-[150px] max-w-[106px] px-3 py-3 bg-transparent active:bg-bg-transparent  border-[1px] border-[#1C1C1E]   focus:border-transparent text-base"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full lg:max-w-[712px] max-w-[266px] px-3 py-3 bg-transparent active:bg-bg-transparent  border-[1px] border-[#1C1C1E]   focus:border-transparent text-base"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full lg:max-w-[300px] max-w-[383px] px-3 py-3 bg-transparent active:bg-bg-transparent  border-[1px] border-[#1C1C1E]  focus:border-transparent text-base"
                      />
                    </div>
          ...
          <div className="lg:hidden order-4 items-center">
            <div className="">
              {/* Line Separator */}
              ...
              <div className="mb-6">
                <div className="flex flex-col gap-2">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="flex-1 px-3 py-3 bg-gray-50 border border-gray-300 
              ...
              <div className="mb-6">
                <div className="flex gap-2">
                  <input
                    ...
                    value={formData.discountCode}
                    onChange={handleInputChange}
                    className="w-full lg:max-w-[371px] max-w-[266px] px-3 py-3 bg-transparent active:bg-bg-transparent  border-[1px] border-[#1C1C1E] focus:border-transparent text-base"
                  />
                  <button
                    type="button"
                    onClick={handleApplyDiscount}
